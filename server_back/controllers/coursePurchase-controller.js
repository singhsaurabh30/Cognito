...
export const createCheckOutSession = async (req, res) => {
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      mode: "payment",
      success_url: `https://cognito-zots.onrender.com/course-progress/${courseId}`, // once payment successful redirect to course progress page
      cancel_url: `https://cognito-zots.onrender.com/course-detail/${courseId}`,
      metadata: {
        courseId: courseId,
        userId: userId,
      },
