...
const Dashboard = () => {
  ...
  return (
    <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
      ...
      <Card className="shadow-lg hover:shadow-xl transition-shadow duration-300 col-span-1 sm:col-span-2 md:col-span-3 lg:col-span-4 dark:bg-gray-800 dark:text-white">
        <CardHeader>
          ...
          <ResponsiveContainer width="100%" height={250}>
            <LineChart data={courseData}>
              ...
              <XAxis
                ...
                dy={0}
                tick={{ fontSize: 14, wordWrap: 'break-word' }}
              />
              <YAxis stroke="#6b7280" />
